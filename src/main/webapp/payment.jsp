            ...
            <div class="space-y-3 mb-4">
              ...
              <div class="border-t border-dashed border-neutral-200 pt-3">
                <div class="flex justify-between">
                  ...
                  <span class="font-bold text-xl text-primary">¥<%= subtotal.subtract(new BigDecimal("0.00")).setScale(2, BigDecimal.ROUND_HALF_UP) %></span>
                </div>
              </div>
            </div>
            <form action="pay.jsp" method="post">
  <input type="hidden" name="orderNumber" value="<%= orderNumber %>">
  <input type="hidden" name="totalAmount" value="<%= subtotal.subtract(new BigDecimal("0.00")).setScale(2, BigDecimal.ROUND_HALF_UP) %>">
