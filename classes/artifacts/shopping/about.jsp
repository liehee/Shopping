  ...
  <section class="mb-12">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-white rounded-xl shadow-custom overflow-hidden hover-scale">
        <div class="relative">
          <img src="yy.jpg" alt="杨烨 - 组长" class="w-full h-64 object-cover">
      ...
      <div class="bg-white rounded-xl shadow-custom overflow-hidden hover-scale">
        <div class="relative">
          <img src="lxl.jpg" alt="林金鸿 - 组员" class="w-full h-64 object-cover">
          <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
      ...
      <div class="bg-white rounded-xl shadow-custom overflow-hidden hover-scale">
        <div class="relative">
          <img src="mxy.jpg" alt="王之颖 - 组员" class="w-full h-64 object-cover">
          <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
      ...
      <div class="bg-white rounded-xl shadow-custom overflow-hidden hover-scale">
        <div class="relative">
          <img src="miko.jpg" alt="赖宜和 - 组员" class="w-full h-64 object-cover">
          <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
