  ...
  <main class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-xl shadow-custom overflow-hidden max-w-2xl mx-auto">
      <div class="px-6 py-4 border-b border-neutral-200">
        <h2 class="text-xl font-bold">请完成支付</h2>
      </div>
      ...
      <div class="p-6">
        ...
        <div class="mb-6 pb-6 border-b border-neutral-200">
          ...
          <div class="flex justify-between">
            <span class="text-neutral-600">支付金额</span>
            <span class="font-bold text-xl text-primary">¥<%= request.getParameter("totalAmount") %></span>
          </div>
        </div>
        ...
        <div class="text-center mb-8">
          <div class="bg-white p-4 rounded-lg shadow-lg inline-block mb-4">
            <!-- 实际项目中这里应该显示真实的支付二维码 -->
            <img src="pic_1.jpg" alt="支付二维码" class="w-64 h-64 object-cover rounded-lg">
          </div>
          <p class="text-sm text-neutral-500">请使用支付宝扫描二维码完成支付</p>
          <p class="text-sm text-neutral-500 mt-1">支付成功后请点击下方"已完成支付"按钮</p>
        </div>
        
        <!-- 支付按钮 -->
        <div class="flex justify-center space-x-4">
          <button class="px-8 py-3 bg-white border border-neutral-300 text-neutral-700 rounded-lg hover:bg-neutral-50 transition-custom" onclick="window.location.href='sort.jsp'">
            取消支付
          </button>
          <button class="px-8 py-3 bg-primary hover:bg-primary/90 text-white rounded-lg transition-custom" onclick="window.location.href='orderSuccess.jsp'">
            已完成支付
          </button>
        </div>
      </div>
